...
<table class="equ">
	...
	<!-- <tr class="equ">
		...
		<td class="equ">{{ per_case_result["slice_nodule_ref"].get("dce_score", "---") }} mm</td>
	</tr> -->
	<tr class="equ">
		<td class="equ">DCE:</td>
		<td class="equ">{{ per_case_result["slice_nodule_ref"].get("dice_coefficient", "---") }}</td>
	</tr>
	<tr class="equ">
		<td class="equ">Detection:</td>
		<td class="equ">{{ per_case_result["slice_nodule_ref"].get("class", "---") }}</td>
	</tr>
	<tr class="equ">
		<td class="equ">Pred Detection:</td>
		<td class="equ">{{ per_case_result["slice_nodule_ref"].get("pred_detection", "---") }}</td>
	</tr>
	<tr class="equ">
		<td class="equ">Ref Detection:</td>
		<td class="equ">{{ per_case_result["slice_nodule_ref"].get("ref_detection", "---") }}</td>
	</tr>
</table>
