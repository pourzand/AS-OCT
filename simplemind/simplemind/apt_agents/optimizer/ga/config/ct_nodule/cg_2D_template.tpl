...
<!-- 	<col width="200">
	...
	<tr class="equ">
		<th class="equ">1st/3rd quartiles</th>
		<td class="equ">{{ final_result["slice_nodule_ref"]["dice_coefficient_q1"] }}, {{ final_result["slice_nodule_ref"]["dice_coefficient_q3"] }}</td>
	</tr>
	<tr class="equ">
...
{% for key in final_result["bad_cases"]["slice_nodule_ref"] -%}
	<tr class="list">
		...
		<!-- <td class="list">{{final_result["per_case_result"][key]["slice_nodule_ref"].get("dce_score")}}</td> -->
		<td class="list">{{final_result["per_case_result"][key]["slice_nodule_ref"].get("dice_coefficient")}}</td>
		<td class="list">{{final_result["per_case_result"][key]["slice_nodule_ref"].get("class")}}</td>
	</tr>
{%- endfor %}
</table>
{%- endif %}
