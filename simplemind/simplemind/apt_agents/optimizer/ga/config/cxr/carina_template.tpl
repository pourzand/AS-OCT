...
<!-- 	<col width="200">
	...
	<tr class="equ">
		...
		<td class="equ">{{ final_result["Crina"]["x_err_mean"] }}</td>
	</tr>
	<tr class="equ">
		<th class="equ">std</th>
		<td class="equ">{{ final_result["Crina"]["x_err_std"] }}</td>
	</tr>
	<tr class="equ">
		<th class="equ">median</th>
		<td class="equ">{{ final_result["Crina"]["x_err_median"] }}</td>
	</tr>
	<tr class="equ">
		<th class="equ">1st/3rd quartiles</th>
		<td class="equ">{{ final_result["Crina"]["x_err_q1"] }}, {{ final_result["Crina"]["x_err_q3"] }}</td>
	</tr>
	<tr class="equ">
	...
	<tr class="equ">
		<th class="equ">mean</th>
		<td class="equ">{{ final_result["Crina"]["y_err_mean"] }}</td>
	</tr>
	<tr class="equ">
		<th class="equ">std</th>
		<td class="equ">{{ final_result["Crina"]["y_err_std"] }}</td>
	</tr>
	<tr class="equ">
		<th class="equ">median</th>
		<td class="equ">{{ final_result["Crina"]["y_err_median"] }}</td>
	</tr>
	<tr class="equ">
		<th class="equ">1st/3rd quartiles</th>
		<td class="equ">{{ final_result["Crina"]["y_err_q1"] }}, {{ final_result["Crina"]["y_err_q3"] }}</td>
	</tr>
	<tr class="equ">
	...
	<tr class="equ">
		<th class="equ">mean</th>
		<td class="equ">{{ final_result["Crina"]["tot_err_mean"] }}</td>
	</tr>
	<tr class="equ">
		<th class="equ">std</th>
		<td class="equ">{{ final_result["Crina"]["tot_err_std"] }}</td>
	</tr>
	<tr class="equ">
		<th class="equ">median</th>
		<td class="equ">{{ final_result["Crina"]["tot_err_median"] }}</td>
	</tr>
	<tr class="equ">
		<th class="equ">1st/3rd quartiles</th>
		<td class="equ">{{ final_result["Crina"]["tot_err_q1"] }}, {{ final_result["Crina"]["tot_err_q3"] }}</td>
	</tr>
	<tr class="equ">
...
<table class="list">
	...
	<tr class="list">
		...
		<td class="list">{{final_result["per_case_result"][key]["Crina"].get("x_err")}}</td>
		<td class="list">{{final_result["per_case_result"][key]["Crina"].get("y_err")}}</td>
		<td class="list">{{final_result["per_case_result"][key]["Crina"].get("tot_err")}}</td>
		<td class="list">{{final_result["per_case_result"][key]["Crina"].get("class")}}</td>
	</tr>
{%- endfor %}
</table>
{%- endif %}
