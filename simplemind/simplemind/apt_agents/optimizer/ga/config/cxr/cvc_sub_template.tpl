...
{% for i in per_case_result["visuals"]["preprocessed_ss"] -%}

<img width=45% src="{{ to_html(i) }}" >
{%- endfor %}
...
<table class="equ">
	...
	<tr class="equ">
		...
		<td class="equ">{{ per_case_result["CVC"].get("dce_score", "---") }} mm</td>
	</tr>
	<tr class="equ">
		<td class="equ">Detection:</td>
		<td class="equ">{{ per_case_result["CVC"].get("class", "---") }}</td>
	</tr>
	<tr class="equ">
		<td class="equ">DCE:</td>
		<td class="equ">{{ per_case_result["CVC"].get("dice_coefficient", "---") }}</td>
	</tr>
	<tr class="equ">
		<td class="equ">Pred Detection:</td>
		<td class="equ">{{ per_case_result["CVC"].get("pred_detection", "---") }}</td>
	</tr>
	<tr class="equ">
		<td class="equ">Ref Detection:</td>
		<td class="equ">{{ per_case_result["CVC"].get("ref_detection", "---") }}</td>
	</tr>
</table>
