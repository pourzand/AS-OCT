...
<!-- 	<col width="200">
	...
	<tr class="equ">
		...
		<td class="equ">{{ final_result["NgTub"]["dce_score_mean"] }}</td>
	</tr>
	<tr class="equ">
		<th class="equ">std</th>
		<td class="equ">{{ final_result["NgTub"]["dce_score_std"] }}</td>
	</tr>
	<tr class="equ">
		<th class="equ">median</th>
		<td class="equ">{{ final_result["NgTub"]["dce_score_median"] }}</td>
	</tr>
	<tr class="equ">
		<th class="equ">1st/3rd quartiles</th>
		<td class="equ">{{ final_result["NgTub"]["dce_score_q1"] }}, {{ final_result["NgTub"]["dce_score_q3"] }}</td>
	</tr>
	<tr class="equ">
	...
	<tr class="equ">
		<th class="equ">mean</th>
		<td class="equ">{{ final_result["NgTub"]["dice_coefficient_mean"] }}</td>
	</tr>
	<tr class="equ">
		<th class="equ">std</th>
		<td class="equ">{{ final_result["NgTub"]["dice_coefficient_std"] }}</td>
	</tr>
	<tr class="equ">
		<th class="equ">median</th>
		<td class="equ">{{ final_result["NgTub"]["dice_coefficient_median"] }}</td>
	</tr>
	<tr class="equ">
		<th class="equ">1st/3rd quartiles</th>
		<td class="equ">{{ final_result["NgTub"]["dice_coefficient_q1"] }}, {{ final_result["NgTub"]["dice_coefficient_q3"] }}</td>
	</tr>
	<tr class="equ">
...
{% if final_result["bad_NG_Tube_seg_cases"] -%}
...
{% for key in final_result["bad_NG_Tube_seg_cases"] -%}
	<tr class="list">
		<td class="list"><a href="sub_report/{{key}}.html">{{key}}</a></td>
		<td class="list">{{final_result["per_case_result"][key]["NgTub"].get("dce_score")}}</td>
		<td class="list">{{final_result["per_case_result"][key]["NgTub"].get("dice_coefficient")}}</td>
		<td class="list">{{final_result["per_case_result"][key]["NgTub"].get("class")}}</td>
	</tr>
{%- endfor %}
</table>
{%- endif %}
...
<table class="list">
	<tr class="list">
		...
		<th class="list">NgTub Error</th>
		<th class="list">ET Correct</th>
		<th class="list">NgTub Correct</th>
	</tr>
