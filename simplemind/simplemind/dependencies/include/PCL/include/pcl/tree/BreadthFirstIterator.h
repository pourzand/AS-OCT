#ifndef PCL_TREE_BREADTH_FIRST_ITERATOR
#define PCL_TREE_BREADTH_FIRST_ITERATOR
...
namespace pcl
{
	namespace tree
	{
		...
		class BreadthFirstIterator: private boost::noncopyable
		{
		public:
			BreadthFirstIterator(const TreeType& tree)
			{
				m_Tree = &tree;
		...
		protected:
			...
			mutable std::queue<IdGen> m_Queue;
